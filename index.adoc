...
Presentation link:presentations/gr8confeu2015/gr8conf/gr8conf-event-driven-plugins.pdf[Event-driven plugins with Grails 3^]. Presented at GR8Conf Europe 2015.
